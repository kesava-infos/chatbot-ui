...
export default function Login() {
    ...
    return <div className="bg-[#f2f2f2] h-screen flex gap-1 p-4 sm:p-8 md:p-4">
        <div className="overflow-hidden md:w-[55%] lg:w-[60%] flex hidden sm:block relative">
            <img src={bg} alt="Background Image" className="self-end h-[90%] absolute top-[50px] md:right-[5px]" />
            <img src={settingsIcon} alt="icon setttings" className="w-[60px] opacity-25 absolute bottom-[50px] sm:left-[-100px] md:left-[80px]" />
            <img src={chat} alt="icon setttings" className="w-[50px] opacity-25 absolute top-[50px] sm:left-[-100px] md:left-[320px]" />
            <img src={bell} alt="icon setttings" className="w-[50px] opacity-25 absolute top-[105px] sm:left-[-100px] md:left-[70px]" />
            <img src={graph} alt="icon setttings" className="w-[50px] opacity-25 absolute top-[275px] sm:left-[-100px] md:left-[220px]" />
        </div>
