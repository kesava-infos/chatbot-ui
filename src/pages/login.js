...
export default function Login() {
    return <div className="bg-[#f2f2f2] h-screen flex gap-1 p-4 sm:p-8 md:p-4">
        ...
        <div className="flex flex-col items-center gap-2 justify-start min-w-[320px] bg-white  h-[96%] rounded-3xl grow p-6">
            ...
            <div className=" bg-[#03234D] flex flex-col gap-4 rounded-3xl w-[100%] text-white">
                ...
                <InputTextField color="#F86167" border="#fff" label="User Name" />
